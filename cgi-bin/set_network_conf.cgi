...
ant_conf_hostname=`echo $ant_conf_hostname | sed 's/\$//g' |  sed 's/ //g' | sed 's/\`//g'`;
ant_conf_ipaddress=`echo $ant_conf_ipaddress | sed 's/\$//g' |  sed 's/ //g' | sed 's/\`//g'`;
ant_conf_netmask=`echo $ant_conf_netmask | sed 's/\$//g' |  sed 's/ //g' | sed 's/\`//g'`;
ant_conf_gateway=`echo $ant_conf_gateway | sed 's/\$//g' |  sed 's/ //g' | sed 's/\`//g'`;
ant_conf_dnsservers=`echo $ant_conf_dnsservers| sed 's/\$//g' |  sed 's/ //g' | sed 's/\`//g'`
...
/etc/init.d/network.sh  >/dev/null 2>&1
/etc/init.d/avahi restart  >/dev/null 2>&1
